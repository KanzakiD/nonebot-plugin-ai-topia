...
<a href="./LICENSE">
    <img src="https://img.shields.io/github/license/kanzakiD/nonebot-plugin-ai-topia.svg" alt="license">
</a>
<a href="https://pypi.python.org/pypi/nonebot-plugin-ai-topia">
    <img src="https://img.shields.io/pypi/v/nonebot-plugin-ai-topia.svg" alt="pypi">
</a>
...
1. 点击 [![start-course](https://user-images.githubusercontent.com/1221423/235727646-4a590299-ffe5-480d-8cd5-8194ea184546.svg)](https://github.com/new?template_kanzakiD=A-kirami&template_name=nonebot-plugin-ai-topia&kanzakiD=%40me&name=nonebot-plugin-&visibility=public) 创建仓库
2. 在创建好的新仓库中, 在 "Add file" 菜单中选择 "Create new file", 在新文件名处输入`LICENSE`, 此时在右侧会出现一个 "Choose a license template" 按钮, 点击此按钮选择开源协议模板, 然后在最下方提交新文件到主分支
3. 全局替换`kanzakiD`为仓库所有者ID; 全局替换`nonebot-plugin-ai-topia`为插件名; 全局替换`nonebot_plugin_ai_topia`为包名; 修改 python 徽标中的版本为你插件的运行所需版本
